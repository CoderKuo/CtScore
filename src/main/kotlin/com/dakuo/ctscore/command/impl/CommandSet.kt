            ...
            dynamic {
                ...
                dynamic {
                    ...
                    execute<ProxyCommandSender>{ sender, context, argument ->
                        ...
                        if (scoreById != null) {
                            CtScore.handler.set(scoreById, Bukkit.getOfflinePlayer(context.argument(-2)).uniqueId,argument.toDouble())
                            sender.sendLang("Set",context.argument(-2),scoreById.name,argument.toDouble())
                        }else{
